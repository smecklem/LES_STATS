...
!c    &        a(7)*t4
        l2 = -a(1)*ti2 + a(2)*ti*tln + a(3) + 0.5d0*a(4)*tt + thd*a(5)*t2 + 0.25d0*a(6)*t3 + 0.2d0*a(7)*t4 + a(8)*ti
!        l2  =      -a(1)*ti2 +     a(2)*ti*tln +a(3)+ &
!              0.5d0*a(4)*tt  + thd*a(5)*t2     + 0.25d0*a(6)*t3 +&
!              0.2d0*a(7)*t4  +     a(8)*ti
        dl2 = 2.0d0*a(1)*ti3     + a(2)*ti2*(1.0d0 - tln) + 0.5d0*a(4)+2.0d0*thd*a(5)*tt  + 0.75d0*a(6)*t2 + 0.8d0*a(7)*t3 - a(8)*ti2

        l3  = -0.5d0*a(1)*ti2 -       a(2)*ti +     a(3)*tln +a(4)*tt  + 0.5d0*a(5)*t2 + thd*a(6)*t3  +0.25d0*a(7)*t4  +       a(9)
        dl3 = a(1)*ti3 + a(2)*ti2 + a(3)*ti + a(4) + a(5)*tt +a(6)*t2  + a(7)*t3
